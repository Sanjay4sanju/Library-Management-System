...
# Add your droplet IP and domain to allowed hosts
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1').split(',')
ALLOWED_HOSTS.append('.digitalocean.com')  # Add Digital Ocean domains

# Add your droplet IP address
# ALLOWED_HOSTS.append('your-droplet-ip-address')
...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://lms_user:lms_password@localhost:5432/lms_db'),
        conn_max_age=600,
        ssl_require=not DEBUG
    )
}

# Alternative database configuration if you prefer explicit settings
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': config('DB_NAME', default='lms_db'),
#         'USER': config('DB_USER', default='lms_user'),
#         'PASSWORD': config('DB_PASSWORD', default='secure-password'),
...
# Enhanced WhiteNoise configuration for production
